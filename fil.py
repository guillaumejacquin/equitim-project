...
#         fig.add_annotation(x=2.25, y=100 - 2,text= ("Niveau de<br> Référence<br> (" + str(niveau_autocall[2]) + "%)"), showarrow=False,
...
#         })
#     # fig.show()
#     fig.write_image("file_name222.png", format="png", scale=5, engine='kaleido')
