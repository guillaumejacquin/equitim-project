def balisedeg(Class):
    if (Class.type_bar == "degressif" or Class.type_bar == "airbag"):
        ...
        Class.balisedeg2 = """La barrière de remboursement anticipé automatique est dégressive au fil du temps. 
        Elle est fixée à <BAC> du <NDR>  en fin de <F0> <1PR>, puis décroît de <DEG>% chaque <F0>, 
        pour atteindre <ADBAC> du <NDR> à la fin du <F0> <ADPR>."""
